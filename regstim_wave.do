...
add wave -noupdate -radix decimal /regstim/dut/ReadData1
add wave -noupdate -radix unsigned /regstim/dut/ReadData2
add wave -noupdate -radix hexadecimal /regstim/dut/decoderOut
add wave -noupdate /regstim/dut/registerOut
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {137432741 ps} 0}
...
update
WaveRestoreZoom {0 ps} {773695431 ps}
